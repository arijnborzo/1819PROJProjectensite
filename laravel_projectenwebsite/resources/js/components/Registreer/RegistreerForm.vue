                ...
                <div>
                    ...
                    <form @submit.prevent="handleSubmit">
                        <div class="form-group">
                            ...
                            <div v-if="submitted && !$v.user.firstName.required" class="invalid-feedback">Voornaam is vereist</div>
                        </div>
                        <div class="form-group">
                            ...
                            <div v-if="submitted && !$v.user.lastName.required" class="invalid-feedback">Familienaam is vereist</div>
                        </div>
                        <div class="form-group">
