      ...
      <b-col cols="10" id="nieuwproj">
        <b-card class="p-3">
          ...
          <b-form @submit="onSubmit" @reset="onReset" v-if="show">
            ...
            >
              <b-form-input id="titel" v-model="form.titel" required></b-form-input>
            </b-form-group>

            <b-form-group
              id="input-group-2"
              label="Korte beschrijving"
              label-for="kortebeschrijving"
            >
              <b-form-textarea
            ...
            <b-form-group id="input-group-3" label="Hoofdvraag" label-for="hoofdvraag">
              <b-form-input id="hoofdvraag" v-model="form.hoofdvraag" required></b-form-input>
            </b-form-group>
            ...
            <b-form-group
              id="input-group-8"
              label="Indien u al document(en) wilt voorleggen aan de docent, kan u deze in een ZIP versturen"
            >
              <b-form-file
